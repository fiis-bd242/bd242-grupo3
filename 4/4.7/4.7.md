...
| **Titulo**      |       **Descripcion**       |
|----------------|------------------------------|
|**Excepciones** |1. Falta de datos en el sistema por ausencia de registros previos. <br> 2. Inconsistencias o errores en la carga de información. <br> 3. Problemas de acceso a la plataforma digital durante la evaluación de los reportes. |
