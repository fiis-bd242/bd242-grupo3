...
![Principal-mantenimiento](../Imagenes/prototipo-principal-mantenimiento.png)
...
![Principal-mantenimiento](../Imagenes/Prototipo-estado%20supervisor.png)

## **Área de almacén**
Pantalla principal al seleccionar el módulo de gestión de repuestos e insumos
![Principal-mantenimiento](../Imagenes/prototipo-principal-almacen.png)

### Vista en caso desee ver la lista de entrega y cambiar el estado de las solicitudes
![Principal-mantenimiento](../Imagenes/prototipo-secundario-reserva-almacen.png)
