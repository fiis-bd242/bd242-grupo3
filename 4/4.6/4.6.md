...
<table border="1">
  <tbody>
    ...
    <tr>
      <td>Actor inicializador</td>
      <td colspan="2">Usuario (Supervisor, Administrador, Empleado)</td>
    </tr>
    <tr>
      <td>Actores participantes</td>
      <td colspan="2">Sistema de gestión de sesiones</td>
    </tr>
    <tr>
      <th>Flujo de eventos</th>
      <td>
        <ol>
          ...
          <li>Mientras el usuario interactúa con el sistema, se monitorea el tiempo de inactividad.</li>
    ...
    <tr>
      <td>Casos de uso incluidos</td>
      <td colspan="2">Monitoreo de tiempo de inactividad del usuario, Advertencia de cierre de sesión</td>
    </tr>
    <tr>
      <td>Servicios utilizados</td>
      <td colspan="2">Sistema de gestión de sesiones</td>
