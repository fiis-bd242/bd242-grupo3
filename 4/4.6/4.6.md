...
| **Requisitos no funcionales** | Interfaz intuitiva y accesible desde dispositivos móviles para la solicitud y restablecimiento de contraseña.<br>Seguridad en el envío del enlace de recuperación y la creación de la nueva contraseña. |
|------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|
