...
| 5    | El sistema cambia la contraseña anterior a una provisional y la envia al usuario por correo electronico. |
| 6    | El usuario recibe el correo y digita la nueva contraseña en el login. |
| 7    | El usuario ingresa y cambia la contraseña provisional por otra diferente |
| 8    | El sistema valida la nueva contraseña y la actualiza en el perfil del usuario. |
...
| Paso | Excepción |
|------|-----------|
| 2a   | Si el correo electrónico no está registrado, el sistema muestra un mensaje de error indicando que no se encontró una cuenta asociada. |
| 3a   | Si el correo electrónico no llega, el usuario puede solicitar el reenvío de correo. |
| 7a   | Si la nueva contraseña no cumple con los requisitos de seguridad (longitud mínima, caracteres especiales, etc.), el sistema solicita al usuario que ingrese una contraseña válida. |


#### Precondición:

- El usuario debe tener una cuenta registrada en el sistema con una dirección de correo electrónico válida.
...
- Interfaz intuitiva y accesible desde dispositivos móviles para la solicitud y restablecimiento de contraseña.
- Seguridad en el envío del enlace de recuperación y la creación de la nueva contraseña.
