...
| **ESTADO INICIAL** | CHAR                       | X (17)         | NOT NULL                     | ----   | ----        | Máquina arreglada en el mantenimiento correctivo        | Identifica la máquina arreglada                                    |
| **ESTADO FINAL** | CHAR                       | ----           | NOT NULL                     | ----   | ----        | Características y fallas detectadas del equipo          | Identifica el tipo de mantenimiento a realizar                     |
| **FECHA_PROGRAMADA_FINAL**     | CHAR                       | ----           | No nulo                      | ----   | ----        | Resumen de procesos del mantenimiento y resultados      | Identifica los procesos aplicados al equipo                        |
| **TIPO_REGISTRO**     | CHAR                       | ----           | ----                         | ----   | ----        | Conjunto de componentes externos usados en el mantenimiento | Identifica los componentes usados en el mantenimiento              |
