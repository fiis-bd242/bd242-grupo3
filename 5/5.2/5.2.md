...
| **Acceso** | VARCHAR | X(50) | NOT NULL | ---- | ---- | Acceso asignado al empleado | Define el tipo de acceso que tiene el empleado (usuario, administrador, master) |
| **Cargo** | VARCHAR | X(50) | NOT NULL | ---- | ---- | Cargo asignado al empleado | Define el cargo del empleado|
...
| **Reponsable** | INT | ---- | NOT NULL | ---- | ---- | Codigo del responsable del almacen | Responsable de la gestion del almacen |
| **Categoria** | VARCHAR | X(25) | NOT NULL | ---- | ---- | Tipo de recursos que se almacena | Permite identificar el almacén correcto para recursos |
| **Estado** | VARCHAR | X(25) | NOT NULL | ---- | ---- | Estado del almacén | Indica si el almacén se encuentra en uso o desuso |
...
| **Tipo_equipo_soporte** | VARCHAR | X(25) | NOT NULL | ---- | ---- | Tipo de equipo de soporte | Clasificación según función o tipo |
...
| **Disponibilidad** | VARCHAR | X(25) | NOT NULL | ---- | ---- | Disponibilidad actual del equipo | Permite saber la disponibilidad del equipo |
| **Estado** | VARCHAR | X(25) | NOT NULL | ---- | ---- | Estado actual del equipo | Permite saber el estado actual del equipo |
...
| **Direccion**| CHAR                     | ----           | No nulo                              | ----   | ----        | Dirección física de la empresa del proveedor     | Dirección para obtener los insumos      |
| **Categoria**| INT                      | 9              | TAB6                                 | ----   | ----        | Tipo de recurso que provee                      | Permite identificar el insumo que se está proveyendo |

--- 
## Insumo

**Semántica**: Insumo complementario disponible para las actividades de mantenimiento

| Atributo   | Naturaleza (tipo de valor) | Formato        | Valores válidos                      | Unidad | Derivada de | Semántica (descripción)                          | Ontología (rol en el negocio)                       |
|------------|----------------------------|----------------|--------------------------------------|--------|-------------|--------------------------------------------------|----------------------------------------------------|
| **Fecha_registro**| DATE                      | AAAA/MM/DD         | Válido en calendario                            | ----   | ----        | Fecha de adquisión del recurso               | Indica la fecha de llegada a almacen de un insumo comprado al proveedor       |
| **Nombre**    | CHAR                      | ---    | No nulo                     | ----   | ----        | Descripción breve del insumo          | Descripción del insumo para su posterior muestra al que lo solicite      |
| **Cantidad**| INT                      | ---           | >= 0                              | ----   | ----        | Cantidad de recurso ingresado a almacen | Permite saber la cantidad de insumos que se disponen |

--- 
--- 
## Solicitud de compra del área de mantenimiento

**Semántica**: Solicitudes de compra registradas en el sistema por el área de mantenimiento

| Atributo   | Naturaleza (tipo de valor) | Formato        | Valores válidos                      | Unidad | Derivada de | Semántica (descripción)                          | Ontología (rol en el negocio)                       |
|------------|----------------------------|----------------|--------------------------------------|--------|-------------|--------------------------------------------------|----------------------------------------------------|
| **Fecha**| DATE                      | AAAA/MM/DD         | Válido en calendario                            | ----   | ----        | Fecha de adquisión del recurso               | Indica la fecha de registro de la solicitud de compra       |
| **Hora**    | TIME                      | HH:MM:SS    | No nulo                     | Horas válidas de 00:00:00 hasta 23:59:59   | ----        | Hora del registro de la solicitud de compra          | Mantiene documentación de todos los registros      |
| **Cantidad**| INT                      | ---           | >= 0                              | ----   | ----        | Cantidad de insumo solicitado para su posterior compra | Permite saber la cantidad de insumo que se necesita comprar|
| **Tipo_urgencia**| VARCHAR(255)                      | ---           | ---                              | ----   | ----        |  | Permite saber el nivel de urgencia de la solicitud de compra |

--- 
## Pedido

**Semántica**: Todos los pedidos registrados de herramientas para el mantenimiento de maquinarias

| Atributo   | Naturaleza (tipo de valor) | Formato        | Valores válidos                      | Unidad | Derivada de | Semántica (descripción)                          | Ontología (rol en el negocio)                       |
|------------|----------------------------|----------------|--------------------------------------|--------|-------------|--------------------------------------------------|----------------------------------------------------|
| **Numero**| INT                     | ---         | >0                            | ----   | ----        | Número asociado al registro de un pedido de recurso para determinado mantenimiento               | Permite identificar a un pedido       |
...
**Semántica**: Documento que autoriza la adquisición de bienes o servicios necesarios para el mantenimiento de maquinaria.

| Atributo                | Naturaleza (tipo de valor) | Formato        | Valores válidos              | Unidad | Derivada de | Semántica (Descripción)                              | Ontología (rol en el negocio)                                    |
|-------------------------|----------------------------|----------------|------------------------------|--------|-------------|------------------------------------------------------|-----------------------------------------------------------------|
| **Id_orden_compra**             | INT                        | 999999999      | 8 dígitos                    | ----   | ----        | Identificador único de la orden de compra            | Ayuda a identificar la orden de compra                          |
...
| area                | CHAR                       | X (50)         | NOT NULL                     | ----   | ----        | Nombre del área donde se realiza el informe          | Define el área de enfoque del informe IPERC                      |
...
**Nota**: Los nuevos campos `unidad_minera`, `area`, y `proceso` están definidos como `CHAR` con un límite de caracteres para almacenar nombres de texto. No es necesario vincular estos campos a IDs en esta estructura, ya que solo contienen los nombres descriptivos.
