...
| Atributo | Naturaleza (tipo de valor) | Formato   | Valores válidos | Unidad | Derivada de | Semántica (descripción) | Ontología (rol en el negocio) |
|------    |----------------------------|-----------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **ID_Cargo** | INT | ---- | NOT NULL | ---- | ---- | Identificador unico del cargo | Identificador del cargo en la empresa, clave para el sistema de gestion|
| **Descripción** | VARCHAR | X(255) | NOT NULL | ---- | ---- | Descripción breve del cargo | Define brevemente las responsabilidades del cargo |
| **Nombre_Cargo** | VARCHAR | X(50) | NOT NULL | ---- | ---- | Nombre del cargo asignado al empleado | Indica el rol del empleado en la empresa |
| **Acceso** | VARCHAR | X(25) | NOT NULL | ---- | ---- | Nivel de acceso que tiene el empleado según su cargo | Define el nivel de privilegio que tiene el empleado dentro del sistema |
...
**Semántica**: Equipos y repuestos disponibles para las actividades de mantenimiento
...
| Atributo                | Naturaleza (tipo de valor) | Formato        | Valores válidos              | Unidad | Derivada de | Semántica (Descripción)                              | Ontología (rol en el negocio)                                    |
|-------------------------|----------------------------|----------------|------------------------------|--------|-------------|------------------------------------------------------|-----------------------------------------------------------------|
| **Cod_orden_compra**             | INT                        | 999999999      | 8 dígitos                    | ----   | ----        | Identificador único de la orden de compra            | Ayuda a identificar la orden de compra                          |
...
| **RUC_proveedor**            | CHAR                       | X (100)        | NOT NULL                     | ----   | ----        | Identificación del proveedor                | Proveedor que suministra los bienes o servicios                  |
...
| **ID_empleado_responsable**       | INT                        | 99999999       | 8 dígitos                    | ----   | ----        | Identificador único que identifica al responsable    | Identifica al empleado                                           |
