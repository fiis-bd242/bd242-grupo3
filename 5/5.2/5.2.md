...
| **Categoria** | INT | X | TAB: Categoría del Almacén | ---- | ---- | Tipo de recursos que se almacena | Permite identificar el almacén correcto para recursos |
| **Estado** | INT | X | TAB: Estado del Almacén | ---- | ---- | Estado del almacén | Indica si el almacén se encuentra en uso o desuso |
...
| **Disponibilidad** | INT | X | TAB: Disponibilidad del equipo de soporte | ---- | ---- | Disponibilidad actual del equipo | Permite saber la disponibilidad del equipo |
| **Estado** | INT | X | TAB: Estado del equipo de soporte | ---- | ---- | Estado actual del equipo | Permite saber el estado actual del equipo |
