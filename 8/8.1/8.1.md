...
3. Boton Guardar y Programar:
	...
	INSERT INTO Equipo_Soporte_X_Mantenimiento (id_equipo_mant, cantidad, id_act_mantto, id_equipo_soporte)
	VALUES 
    (<12>, <13>, <6>, <14>),

	INSERT INTO Insumo_X_Mantenimiento (id_insum_mant, cantidad, id_act_mantto, id_insumo)
	VALUES 
		(<15>, <16>, <6>, <17>),
	```
...
2. Botón Guardar y Programar:
    ...
    Orden_a_Mant.fecha_inicio_programado,
    Orden_a_Mant.fecha_fin_programado,
    null,
    15,
    1,
    1001
