...
# Modulo 3 (Gestion de insumos de mantenimiento)
...
![Exportar Datos](../imagenes/Prototipo%20planificación-vista-general.png)

**Eventos:**

1. **Botón crear reserva:** Se da click en este botón para abrir una interfaz específica para la reserva de insumos.
```sql
   --1 Al ingresar a la opción reservar insumo                      ---elimina los datos de la tabla temporal anterior
...
![Exportar Datos](../imagenes/Prototipo%20planificación-reserva-material.png)
...
[2]= Id_empleado se obtiene del logeo inicial del usuario.
Después de ejecutar las sentencias, se retorna el contador de reservas como número de reserva y posteriormente se actualiza el contador.
...
![Exportar Datos](../imagenes/Prototipo-estado%20de%20solicitud-supervisor.png)
...
1. **Mostrar lista de reservas solicitadas por empleado:** Se da click en este botón para observar el estado de todas sus reservas.
   ...
   ```sql
   --Mostrar lista de solicitudes de reserva del empleado
	SELECT Id_reserva
	FROM Reserva
	WHERE Id_empleado=[1] and Id_estado_reserva <> 0;
	```
...
Esta consulta sirve para saber que boton resaltar con el color morado en la sección estado.
...
![Exportar Datos](../imagenes/Prototipo%20planificación-estado-almacen.png)
...
1. Botón llenado de datos:
	Redirecciona a la interfaz I-402.

1. Botón clasificacion:
	Redirecciona a la interfaz I-406.
...
**Eventos:**
	Muestra todos los registros ipercs editables segun la ultima fecha de act, seleccionar ir redirecciona a la interfaz I-403.
...
1. Boton siguiente:
	...
	INSERT INTO Informe_IPERC (id_informe_iperc, fecha_registro, fecha_act_sup, fecha_act_seg, cant_riesgos_analizados, unidad_minera, area, id_proceso)
	VALUES (?, <6>, <6>, <6>, 0, <5>, <7>, ?);
	```
...
3. Boton culminar:
	...
	Este boton tiene la misma forma de arriba, sin embargo se agrega un update para contar la cantidad de riesgo analizados y luego redirecciona a la interfaz I-405.
...
7. Boton editar:
   	...
   	Este boton nos lleva a otra pantalla unica solo para cambiar los datos redireccionando a la pantalla I-404.
...
**Eventos:**
	Nos muestras todos los IPERCS editables segun ultima fecha de act por el ingenierio de seguridad, redirecciona a la interfaz I-407.
...
<<<<<<< HEAD
# Modulo 5 (Planificación del mantenimiento)
...
=======
 ...
 4.Boton siguiente:
 	Solo nos lleva a la siguiente pantalla porque el registro se hace en el boton evaluar si es que agrada el nivel de riesgo, redirecciona a la interfaz I-408.
...
![Proceso de Planificacion](../imagenes/5pantallaIPERC.png)
>>>>>>> bf38569eb7d45947233f77278b1abc0253125acd
...
![Equipo de Soporte](../Imagenes/Inventario-equipos-soporte.png)
=======
1. Carga de pantalla:
   	Carga la valoracion del riesgo residual y sus controles ingresados anteriormente.
	   
	Visualizacion del riesgo residual
	```sql
	SELECT 
	...
	```
2. Boton culminar y añadir mas:

 	Los dos tiene la misma funcionalidad sin embargo uno abre otro registro y culminar te lleva a otra pantalla, el boto de añadir mas redirecciona a la misma interfaz mientras que el boton de culminar redirecciona a la interfaz I-409.
...
![Proceso de Planificacion](../imagenes/6pantallaIPERC.png)
>>>>>>> bf38569eb7d45947233f77278b1abc0253125acd
...
1. **Botón Exportar Datos:** Se genera la exportación de datos para el formato escogido (Se maneja ya en el backend).
