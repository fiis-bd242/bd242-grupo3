...
3. Boton Guardar y Programar:
	...
	| `<13>`       | Cantidad de un elemento de la lista de equipos de soporte a insertar, obtenida del formulario |
	| `<14>`       | Id de un elemento de la lista de equipos de soporte a insertar, obtenida del formulario |
	| `<15>`       | Id de la tabla InsumoXMantenimiento creado automáticamente |
	| `<16>`       | Cantidad de un elemento de la lista de insumos a insertar, obtenida del formulario |
	| `<17>`       | Id de un elemento de la lista de insumos a insertar, obtenida del formulario |
