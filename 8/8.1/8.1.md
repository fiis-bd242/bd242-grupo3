...
3. Botón Eliminar (Basado en Descripción de Actividad, Tarea y Peligro):

	Primero, obtenemos los identificadores (`id_tarea`, `id_riesgo`, `id_actividad`) que coinciden con las descripciones específicas de la actividad, la tarea, y el peligro que queremos eliminar. Para hacer esto, 	declaramos variables para almacenar los valores.
