...
|----------|----------------------------|---------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **Codigo_empleado** | INT | 99999999 | 8 dígitos | ---- | ---- | Identificador unico del empleado | Identificador del empleado en la empresa, clave para todas las operaciones relacionadas con empleados. |
...
| **Id_cargo** | INT | 999 | 3 digitos | ---- | ---- | Cargo asignado al empleado | Define el cargo del empleado|

---
## Cargo Empleado
**Semantica**: Define los cargos o roles que los empleados pueden ocupar dentro de la organización.

| Atributo | Naturaleza (tipo de valor) | Formato   | Valores válidos | Unidad | Derivada de | Semántica (descripción) | Ontología (rol en el negocio) |
|--------- |----------------------------|-----------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **Id_cargo** | INT | 999 | 3 digitos | ---- | ---- | Identidficador unico del cargo del empleado | Permite saber el rol de cada empleado |
| **Nombre_cargo** | VARCHAR | X(50) | NOT NULL | ---- | ---- | Nombre del cargo | Define el cargo del empleado |
...
| Atributo | Naturaleza (tipo de valor) | Formato   | Valores válidos | Unidad | Derivada de | Semántica (descripción) | Ontología (rol en el negocio) |
|------    |----------------------------|-----------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **Cod_almacen** | INT | 9999 | 4 dígitos | ---- | ---- | Identificador unico del almacén | Identifica cada almacén |
| **Codigo_empleado** | INT | 99999999 | 8 digitos | ---- | ---- | Codigo del responsable del almacen | Responsable de la gestion del almacen |
| **Codigo_categoria** | INT | 999 | 3 digitos| ---- | ---- | Tipo de recursos que se almacena | Permite identificar el almacén correcto para recursos |
| **Codigo_estado** | INT | 999 | 3 digitos | ---- | ---- | Estado del almacén | Indica si el almacén se encuentra en uso o desuso |
...
---
### Categoría Almacén
**Semántica**: Clasifica los almacenes según diferentes categorías para su gestión

| Atributo | Naturaleza (tipo de valor) | Formato   | Valores válidos | Unidad | Derivada de | Semántica (descripción) | Ontología (rol en el negocio) |
|--------- |----------------------------|-----------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **Codigo_categoria** | INT | 999 | 3 digitos | ---- | ---- | Identidficador unico de la categoria del almacen | Permite saber la categoria del almacen |
| **Nombre_categoria** | VARCHAR | X(50) | NOT NULL | ---- | ---- | Nombre de la categoria del almacen | Define la categoria del almacen |

---
### Estado Almacén
**Semántica**: Registra los posibles estados operativos de los almacenes.

| Atributo | Naturaleza (tipo de valor) | Formato   | Valores válidos | Unidad | Derivada de | Semántica (descripción) | Ontología (rol en el negocio) |
|--------- |----------------------------|-----------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **Codigo_estado** | INT | 999 | 3 digitos | ---- | ---- | Identidficador unico del estado del almacen | Permite saber el estado del almacen |
| **Nombre_estado** | VARCHAR | X(50) | NOT NULL | ---- | ---- | Nombre del estado del almacen | Define el estado del almacen |
...
| Atributo | Naturaleza (tipo de valor) | Formato   | Valores válidos | Unidad | Derivada de | Semántica (descripción) | Ontología (rol en el negocio) |
|------    |----------------------------|-----------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **Id_equipo_soporte** | INT | 999999 | 6 dígitos | ---- | ---- | Identificador único de cada equipo de soporte | Identificador primario |
...
| **Tipo_equipo_soporte** | VARCHAR | X(100) | NOT NULL | ---- | ---- | Tipo de equipo de soporte | Clasificación según función o tipo |
...
| **Horas_uso** | INTEGER | ---- | X > 0 | ---- | ---- | Número de horas de uso acumuladas del equipo | Control de uso |
| **Cod_almacen** | INT | 999999 | 6 digitos | ---- | ---- | Código del almacén donde se encuentra el equipo | Permite ubicar en que almacen esta el equipo |
| **Codigo_disponibilidad** | INT | 999 | 3 digitos | ---- | ---- | Disponibilidad actual del equipo | Permite saber la disponibilidad del equipo |
| **Codigo_estado** | INT | 999 | 3 digitos | ---- | ---- | Estado actual del equipo | Permite saber el estado actual del equipo |
...
| Atributo | Naturaleza (tipo de valor) | Formato   | Valores válidos | Unidad | Derivada de | Semántica (descripción) | Ontología (rol en el negocio) |
|------    |----------------------------|-----------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **Id_eqsoportexmantto** | INT | 99999999 | 8 dígitos | ---- | ---- | Identificador único de un equipos asignado a un mantenimiento | Identificador primario |
| **Id_equipo_soporte** | INT | 999999 | 6 digitos | ---- | ---- | Identificador del equipo de soporte asignado | Identificador primario |
| **Cod_Act_mantto** | INT | 99999999 | 8 digitos | ---- | ---- | Codigo del mantenimiento | Identidica de forma unica al mantenimiento |

---
### Disponibilidad Equipo de Soporte
**Semántica**: Registra los diferentes estados de disponibilidad de los equipos de soporte.

| Atributo | Naturaleza (tipo de valor) | Formato   | Valores válidos | Unidad | Derivada de | Semántica (descripción) | Ontología (rol en el negocio) |
|--------- |----------------------------|-----------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **Codigo_disponibilidad** | INT | 999 | 3 digitos | ---- | ---- | Identidficador unico de la disponibilidad del equipo de soporte | Permite saber la disponibilidad del equipo de soporte |
| **Nombre_disponibilidad** | VARCHAR | X(50) | NOT NULL | ---- | ---- | Nombre de la disponibilidad del equipo de soporte | Define la disponibilidad del equipo de soporte |

---
### Estado Equipo de Soporte
**Semántica**: Define los estados físicos o de funcionamiento de los equipos de soporte.

| Atributo | Naturaleza (tipo de valor) | Formato   | Valores válidos | Unidad | Derivada de | Semántica (descripción) | Ontología (rol en el negocio) |
|--------- |----------------------------|-----------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **Codigo_estado** | INT | 999 | 3 digitos | ---- | ---- | Identidficador unico del estado del equipo de soporte | Permite saber el estado del equipo de soporte |
| **Nombre_estado** | VARCHAR | X(50) | NOT NULL | ---- | ---- | Nombre del estado del equipo de soporte | Define el estado del equipo de soporte |
...
| **NIVEL** | CHAR                       | ----           | TAB Y                      | ----   | ----        | Nivel específico de la criticidad          | Permite priorizar planes u órdenes segun el nivel |
