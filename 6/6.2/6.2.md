...
| 4 | Administrador del sistema | Master |
...
| Atributo | Naturaleza (tipo de valor) | Formato   | Valores válidos | Unidad | Derivada de | Semántica (descripción) | Ontología (rol en el negocio) |
|------    |----------------------------|-----------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **ID_autenticador** | INT | 99999999 | NOT NULL | ---- | ---- | Identificador del mecanismo de autenticación utilizado | Identifica el método específico de autenticación en 2 pasos. |
