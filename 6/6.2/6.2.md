...
| **Codigo_cargo** | INT | 999 | 3 digitos | ---- | ---- | Cargo asignado al empleado | Define el cargo del empleado|
...
| Atributo | Naturaleza (tipo de valor) | Formato   | Valores válidos | Unidad | Derivada de | Semántica (descripción) | Ontología (rol en el negocio) |
|--------- |----------------------------|-----------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **Codigo_cargo** | SERIAL | 999 | 3 digitos | ---- | ---- | Identidficador unico del cargo del empleado | Permite saber el rol de cada empleado |
...
| Atributo | Naturaleza (tipo de valor) | Formato   | Valores válidos | Unidad | Derivada de | Semántica (descripción) | Ontología (rol en el negocio) |
|------    |----------------------------|-----------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **Codigo_almacen** | SERIAL | 999999 | 6 dígitos | ---- | ---- | Identificador unico del almacén | Identifica cada almacén |
| **Codigo_responsable** | INT | 99999999 | 8 digitos | ---- | ---- | Codigo del responsable del almacen | Responsable de la gestion del almacen |
| **Direccion** | VARCHAR | X(255) | NOT NULL | ---- | ---- | Direccion fisica del almacen | Ubicacion del almacen |
| **Capacidad** | INTEGER | ---- | X > 0 | ---- | ---- | Capacidad física del almacén             | Indica la capacidad física máxima del almacén         |
| **Codigo_categoria** | INT | 99999 | 5 digitos| ---- | ---- | Tipo de recursos que se almacena | Permite identificar el almacén correcto para recursos |
| **Codigo_estado** | INT | 99999 | 5 digitos | ---- | ---- | Estado del almacén | Indica si el almacén se encuentra en uso o desuso |
...
| Atributo | Naturaleza (tipo de valor) | Formato   | Valores válidos | Unidad | Derivada de | Semántica (descripción) | Ontología (rol en el negocio) |
|--------- |----------------------------|-----------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **Codigo_categoria_almacen** | SERIAL | 999 | 3 digitos | ---- | ---- | Identidficador unico de la categoria del almacen | Permite saber la categoria del almacen |
| **Nombre_categoria_almacen** | VARCHAR | X(50) | NOT NULL | ---- | ---- | Nombre de la categoria del almacen | Define la categoria del almacen |
...
| Atributo | Naturaleza (tipo de valor) | Formato   | Valores válidos | Unidad | Derivada de | Semántica (descripción) | Ontología (rol en el negocio) |
|--------- |----------------------------|-----------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **Codigo_estado_almacen** | SERIAL | 999 | 3 digitos | ---- | ---- | Identidficador unico del estado del almacen | Permite saber el estado del almacen |
| **Nombre_estado_almacen** | VARCHAR | X(50) | NOT NULL | ---- | ---- | Nombre del estado del almacen | Define el estado del almacen |
...
| Atributo | Naturaleza (tipo de valor) | Formato   | Valores válidos | Unidad | Derivada de | Semántica (descripción) | Ontología (rol en el negocio) |
|------    |----------------------------|-----------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **Codigo_equipo_soporte** | SERIAL | 999999 | 6 dígitos | ---- | ---- | Identificador único de cada equipo de soporte | Identificador primario |
...
| **Codigo_tipo_equipo_soporte** | INT | 99999 | 5 digitos | ---- | ---- | Tipo de equipo de soporte | Clasificación según función o tipo |
...
| **Codigo_almacen** | INT | 999999 | 6 digitos | ---- | ---- | Código del almacén donde se encuentra el equipo | Permite ubicar en que almacen esta el equipo |
...
| Atributo | Naturaleza (tipo de valor) | Formato   | Valores válidos | Unidad | Derivada de | Semántica (descripción) | Ontología (rol en el negocio) |
|--------- |----------------------------|-----------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **Codigo_disponibilidad_equipo_soporte** | SERIAL | 999 | 3 digitos | ---- | ---- | Identidficador unico de la disponibilidad del equipo de soporte | Permite saber la disponibilidad del equipo de soporte |
| **Nombre_disponibilidad_equipo_soporte** | VARCHAR | X(50) | NOT NULL | ---- | ---- | Nombre de la disponibilidad del equipo de soporte | Define la disponibilidad del equipo de soporte |
...
| Atributo | Naturaleza (tipo de valor) | Formato   | Valores válidos | Unidad | Derivada de | Semántica (descripción) | Ontología (rol en el negocio) |
|--------- |----------------------------|-----------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **Codigo_estado_equipo_soporte** | SERIAL | 999 | 3 digitos | ---- | ---- | Identidficador unico del estado del equipo de soporte | Permite saber el estado del equipo de soporte |
| **Nombre_estado_equipo_soporte** | VARCHAR | X(50) | NOT NULL | ---- | ---- | Nombre del estado del equipo de soporte | Define el estado del equipo de soporte |

---
### EQUIPO_SOPORTE_X_MANTENIMIENTO
**Semántica**: Relaciona los equipos de soporte con las actividades de mantenimiento asginadas.

| Atributo | Naturaleza (tipo de valor) | Formato   | Valores válidos | Unidad | Derivada de | Semántica (descripción) | Ontología (rol en el negocio) |
|------    |----------------------------|-----------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **Codigo_eqsoportexmtto** | SERIAL | 99999999 | 8 dígitos | ---- | ---- | Identificador único de un equipos asignado a un mantenimiento | Identificador primario |
| **Codigo_equipo_soporte** | INT | 999999 | 6 digitos | ---- | ---- | Identificador del equipo de soporte asignado | Identificador primario |
| **Codigo_mantenimiento** | INT | 99999999 | 8 digitos | ---- | ---- | Codigo del mantenimiento | Identidica de forma unica al mantenimiento |
