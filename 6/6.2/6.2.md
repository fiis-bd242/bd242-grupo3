...
| **Categoria**| CHAR                      | x(255)              | ---                                 | ----   | ----        | Tipo de recurso que provee                      | Permite identificar el recurso que se está proveyendo |

--- 
### Registro_compra_herramientas
## **Semántica**: 
Registro de compra de equipos y repuestos para las actividades de mantenimiento

| Atributo   | Naturaleza (tipo de valor) | Formato        | Valores válidos                      | Unidad | Derivada de | Semántica (descripción)                          | Ontología (rol en el negocio)                       |
|------------|----------------------------|----------------|--------------------------------------|--------|-------------|--------------------------------------------------|----------------------------------------------------|
| **Id_reg_recurso**| INT                      | ---         | no nulo                            | ----   | ----        | Código asociado a la compra de un recurso               | Identificador de un registro de compra recurso comprado al proveedor       |
| **Id_orden_compra**| INT                      | ---         | No nulo                           | ----   | ----        | Código asociado a la orden de compra               | Identificador de una orden de compra registrada en el sistema       |
| **Cod_almacen**| INT                      | ---         | No nulo                            | ----   | ----        | Código asociado a un almacén              | Identificador de un almacén     |
| **Id_herramienta**| INT                      | ---         | No nulo                            | ----   | ----        | Código asociado a un recurso disponible para mantenimiento             | Identificador de un recurso disponnible para mantenimiento    |
...
| **Codigo_empleado**       | INT                        | ---       | No nulo                    | ----   | ----        | Identificador único que identifica al responsable    | Identifica al empleado                                           |
...
| Atributo   | Naturaleza (tipo de valor) | Formato        | Valores válidos                      | Unidad | Derivada de | Semántica (descripción)                          | Ontología (rol en el negocio)                       |
|------------|----------------------------|----------------|--------------------------------------|--------|-------------|--------------------------------------------------|----------------------------------------------------|
| **Numero**| INT                      | ---         | No nulo                            | ----   | ----        | Número asociado al registro de un pedido de recurso para determinado mantenimiento               | Permite identificar a un pedido       |
...
| **Codigo_empleado**       | INT                        | ---       | No nulo                    | ----   | ----        | Identificador único que identifica al responsable del pedido    | Identifica al empleado que hizo el pedido
| **Id_estado**       | INT                        | ---       | TAB_Est                    | ----   | ----        | Identifica el estado actual del pedido    | Indica si el estado del pedido
| **Id_herramienta**       | INT                        | ---       | No nulo                    | ----   | ----        | Código asociado al recurso   | Indica el recurso que está siendo solicitado
...
| Atributo   | Naturaleza (tipo de valor) | Formato        | Valores válidos                      | Unidad | Derivada de | Semántica (descripción)                          | Ontología (rol en el negocio)                       |
|------------|----------------------------|----------------|--------------------------------------|--------|-------------|--------------------------------------------------|----------------------------------------------------|
| **Id_herramienta**       | INT                        | ---       | No nulo                    | ----   | ----        | Código asociado al recurso   | Indica el código de recurso disponible
...
| Atributo   | Naturaleza (tipo de valor) | Formato        | Valores válidos                      | Unidad | Derivada de | Semántica (descripción)                          | Ontología (rol en el negocio)                       |
|------------|----------------------------|----------------|--------------------------------------|--------|-------------|--------------------------------------------------|----------------------------------------------------|
| **Id_HerramientaxMant**       | INT                        | ---       | No nulo                    | ----   | ----        | Código asociado al recurso   | Indica el código de recurso disponible
...
| **ID_herramienta**       | INT                        | ---       | No nulo                    | ----   | ----        | Código asociado al recurso   | Indica el código del recurso disponible
