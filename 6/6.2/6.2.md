...
| **Cod_acceso** | INT | X | TAB: Acceso del empleado | ---- | ---- |  Acceso asignado al empleado | Define el tipo de acceso que tiene el empleado (usuario, administrador, master) |
...
| 3 | Usuario |
=======
| **Id_cargo** | INT | X | TAB: Cargo del empleado | ---- | ---- | Cargo asignado al empleado | Define el cargo del empleado|
...
| 4 | Encargado del sistema | Master |
...
| **Codigo_tipo** | INT | X | TAB: Tipo de equipo de soporte | ---- | ---- | Tipo de equipo de soporte | Clasificación según función o tipo |
...
| **Id_actvempleado** | INT | ---- | NULL | ---- | ---- | Actividad de empleado al cual se le asigna el equipo de soporte | Sirve para identificar quien operan que equipo |
| **Id_orden** | INT | ---- | NULL | ---- | ---- | Orden de trabajo a la cual se le asigna un equipo de soporte | Sirve para identificar que equipos de soporte se utilizaran en un mantenimiento | 
...
## **Semántica**: 
Empresa que brinda los equipos y repuestos necesarios para las actividades de mantenimiento.

| Atributo   | Naturaleza (tipo de valor) | Formato        | Valores válidos                      | Unidad | Derivada de | Semántica (descripción)                          | Ontología (rol en el negocio)                       |
|------------|----------------------------|----------------|--------------------------------------|--------|-------------|--------------------------------------------------|----------------------------------------------------|
| **Empresa**| CHAR                       | ----           | No nulo                              | ----   | ----        | Nombre de la empresa del proveedor               | Establece relación contractual con la empresa       |
| **RUC**    | CHAR                        | x(12)    | 11 dígitos                           | ----   | ----        | Identificador de actividades económicas          | Establece relación contractual con la empresa       |
...
--- 
### Registro compra recursos
## **Semántica**: 
Registro de compra de equipos y repuestos para las actividades de mantenimiento

| Atributo   | Naturaleza (tipo de valor) | Formato        | Valores válidos                      | Unidad | Derivada de | Semántica (descripción)                          | Ontología (rol en el negocio)                       |
|------------|----------------------------|----------------|--------------------------------------|--------|-------------|--------------------------------------------------|----------------------------------------------------|
| **Cod_reg_recurso**| CHAR                      | x(9)         | 8 dígitos                            | ----   | ----        | Código asociado a la compra de un recurso               | Identificador de un registro de compra recurso comprado al proveedor       |
| **Cod_orden_compra**| CHAR                      | x(9)         | 8 dígitos                            | ----   | ----        | Código asociado a la orden de compra               | Identificador de una orden de compra registrada en el sistema       |
| **Cod_almacen**| CHAR                      | x(9)         | 8 dígitos                            | ----   | ----        | Código asociado a un almacén              | Identificador de un almacén     |
| **Cod_recurso**| CHAR                      | x(9)         | 8 dígitos                            | ----   | ----        | Código asociado a un recurso disponible para mantenimiento             | Identificador de un recurso disponnible para mantenimiento    |
| **Fecha_registro**| DATE                      | AAAA/MM/DD         | Válido en calendario                            | ----   | ----        | Fecha de adquisión del recurso               | Indica la fecha de llegada a almacen de un recurso comprado al proveedor       |
| **Descripcion**    | CHAR                      | ---    | No nulo                     | ----   | ----        | Descripción breve del recurso          | Documenta todo recurso que ingresa a almacén      |
| **Cantidad**| INT                      | ---           | >= 0                              | ----   | ----        | Cantidad de recurso ingresado a almacen | Permite saber la cantidad de recursos que se disponen |

--- 
### Orden de compra

## **Semántica**: 
Representa un documento que autoriza la adquisición de bienes o servicios necesarios para el mantenimiento de maquinaria.

| Atributo                | Naturaleza (tipo de valor) | Formato        | Valores válidos              | Unidad | Derivada de | Semántica (Descripción)                              | Ontología (rol en el negocio)                                    |
|-------------------------|----------------------------|----------------|------------------------------|--------|-------------|------------------------------------------------------|-----------------------------------------------------------------|
| **Cod_orden_compra**             | CHAR                        | x(9)      | 8 dígitos                    | ----   | ----        | Identificador único de la orden de compra            | Ayuda a identificar la orden de compra                          |
...
| **RUC**            | CHAR                       | X (12)        | NOT NULL                     | ----   | ----        | Identificación del proveedor                | Proveedor que suministra los bienes o servicios                  |
...
| **Codigo_empleado**       | CHAR                        | x(9)       | 8 dígitos                    | ----   | ----        | Identificador único que identifica al responsable    | Identifica al empleado                                           |
...
## **Semántica**: 
 Todos los pedidos generados que solicitan determinada cantidad de recursos para el mantenimiento de determinada máquinaria

| Atributo   | Naturaleza (tipo de valor) | Formato        | Valores válidos                      | Unidad | Derivada de | Semántica (descripción)                          | Ontología (rol en el negocio)                       |
|------------|----------------------------|----------------|--------------------------------------|--------|-------------|--------------------------------------------------|----------------------------------------------------|
| **Numero**| CHAR                      | ---         | No nulo                            | ----   | ----        | Número asociado al registro de un pedido de recurso para determinado mantenimiento               | Permite identificar a un pedido       |
| **Cant_pedid**    | INT                     | ---    | >=0                    | ----   | ----        |Cantidad de recursos solicitados        | Cantidad solicitada en el pedido      |
| **Fecha**| DATE                      | AAAA/MM/DD          | De acuerdo con calendario                       | ----   | ----        | Fecha en la que fue registrado el pedido | Almacena la fecha que el recurso fue solicitado |
...
| **Codigo_empleado**       | CHAR                        | x(9)       | 8 dígitos                    | ----   | ----        | Identificador único que identifica al responsable del pedido    | Identifica al empleado que hizo el pedido
| **Cod_estado**       | CHAR                        | x(3)       | TAB_Est                    | ----   | ----        | Identifica el estado actual del pedido    | Indica si el estado del pedido
| **Cod_recurso**       | CHAR                        | x(9)       | 8 dígitos                    | ----   | ----        | Código asociado al recurso   | Indica el recurso que está siendo solicitado

TAB_Est: Tipos de estado de un pedido
| Código | Tipo_estad |
|--------|-------------|
| 1 | Aprobado |
...
## **Semántica**: 
 Todos los recursos disponibles y su cantidad

| Atributo   | Naturaleza (tipo de valor) | Formato        | Valores válidos                      | Unidad | Derivada de | Semántica (descripción)                          | Ontología (rol en el negocio)                       |
|------------|----------------------------|----------------|--------------------------------------|--------|-------------|--------------------------------------------------|----------------------------------------------------|
| **Cod_recurso**       | CHAR                        | x(9)       | 8 dígitos                    | ----   | ----        | Código asociado al recurso   | Indica el código de recurso disponible
| **Cantidad**    | INT                     | ---    | >=0                    | ----   | ----        |Cantidad de recursos disponibles       | Cantidad total existente del recurso      |
| **Nombre**| CHAR                      | ---          | ---                       | ----   | ----        | Nombre del recurso | Se identifica al nombre del recurso para su posterior asignación |
### RecursoxMantenimiento

## **Semántica**: 
 Tabla auxiliar para relacion muchos a muchos de recurso,mantenimiento.

| Atributo   | Naturaleza (tipo de valor) | Formato        | Valores válidos                      | Unidad | Derivada de | Semántica (descripción)                          | Ontología (rol en el negocio)                       |
|------------|----------------------------|----------------|--------------------------------------|--------|-------------|--------------------------------------------------|----------------------------------------------------|
| **Id_RecursoxMant**       | CHAR                        | x(9)       | 8 dígitos                    | ----   | ----        | Código asociado al recurso   | Indica el código de recurso disponible
| **Is_Act_Mant**      | INT                            | 99999       | 5 dígitos                  | ----       | ----           | Identificación única de la actividad de mantenimiento     | Identifica la actividad de mantenimiento de forma única |
| **Cod_recurso**       | CHAR                        | x(9)       | 8 dígitos                    | ----   | ----        | Código asociado al recurso   | Indica el código del recurso disponible
...
| Atributo            | Naturaleza (tipo de valor) | Formato        | Valores válidos              | Unidad | Derivada de | Semántica (descripción)                              | Ontología (rol en el negocio)                                  |
|---------------------|----------------------------|----------------|------------------------------|--------|-------------|------------------------------------------------------|---------------------------------------------------------------|
| **CODIGO_PLAN**         | INT                        | 99999999       | 8 dígitos                    | ----   | ----        | Identificador del plan                            | Identifica al plan                                           |
...
| **OBSERVACIONES** | CHAR                       | ----           | No nulo                      | ----   | ----        | Observaciones adicionales al plan         | Permite colocar notas o información adicional en el plan de mantenimiento |
| **EMPLEADO_ASIGNA**      | CHAR                       | ----           | No nulo                      | ----   | ----        | Persona encargada de aprobar el plan de mantenimiento     | Identifica a la persona que aprobó el plan de mantenimiento          |
| **CRITICIDAD**     | CHAR                       | ----       | No nulo         | ----   | ----        | Criticidad del plan de mantenimiento a ejecutarse     | Permite atender los planes de mantenimiento por criticidad |
...
| **DESCRIPCIÓN** | CHAR                       | ----           | No nulo                      | ----   | ----        | Tipo de mantenimiento y procesos realizados          | Justifica la orden de trabajo y sirve de guía para el mantenimiento |
| **EMPLEADO_ASIGNA**      | CHAR                       | ----           | No nulo                      | ----   | ----        | Persona encargada de aprobar la orden de trabajo     | Identifica a la persona que aprobó la orden de trabajo           |
| **PRIORIDAD**     | CHAR                       | ----       | No nulo         | ----   | ----        | Prioridad de la orden de trabajo a ejecutarse     | Permite realizar las órdenes de trabajo según la priorirdad |

---

## Criticidad

**Semántica**: Nivel de criticidad o prioridad relevantes para el plan de mantenimiento o la orden de trabajo en la planificación del mantenimiento.

| Atributo            | Naturaleza (tipo de valor) | Formato        | Valores válidos              | Unidad | Derivada de | Semántica (descripción)                              | Ontología (rol en el negocio)                                  |
|---------------------|----------------------------|----------------|------------------------------|--------|-------------|------------------------------------------------------|---------------------------------------------------------------|
| **ID_CRITICIDAD**         | INT                        | 99999999       | 8 dígitos                    | ----   | ----        | Identificador de la criticidad                          | Identifica la criticidad o prioridad                                           |
| **NIVEL**         | CHAR                        | ----       | TAB CRITICIDAD                    | ----   | ----        | Nivel específico de la criticidad                          | Permite priorizar planes u órdenes segun el nivel                                           |
...
| Atributo            | Naturaleza (tipo de valor) | Formato        | Valores válidos              | Unidad | Derivada de | Semántica (descripción)                              | Ontología (rol en el negocio)                                  |
|---------------------|----------------------------|----------------|------------------------------|--------|-------------|------------------------------------------------------|---------------------------------------------------------------|
| **ID_ACTVEMPLEADO**         | INT                        | 99999999       | 8 dígitos                    | ----   | ----        | Identificador de la actividad de empleado                            | Identifica a la actividad de empleado                                           |
| **DESCRIPCIÓN_ACTIVIDAD** | CHAR                       | ----           | No nulo                      | ----   | ----        | Tareas específicas realizadas por el empleado de forma cronológica          | Permite auditar las actividades de mantenimiento por empleado |
| **CÓDIGO_EMPLEADO**      | CHAR                       | ----           | No nulo                      | ----   | ----        | Persona que realiza la actividad de empleado     | Identifica a la persona que realiza la actividad especificada          |
...
| TIEMPO_MAX_SESION          |  HH:MM:SS                           | minutos     | TAB: Tiempo máximo de sesión               | ----       | ----           | Tiempo máximo permitido para la sesión del empleado                | Limita la duración de la sesión del empleado               |
| ESTADO_SESION      | CHAR                           | X (1)     | TAB: Estado de la sesion                   | ----       | ----           | Estado actual de la sesión (activa, inactiva, bloqueda)                  | Indica el estado de la sesión del empleado           |
...
| DIRECCION_IP        | VARCHAR                         | XXX.XXX.XXX.XXX    | Formato IP válido                    | ----       | ----           | Dirección IP desde donde se inició la sesión             | Identifica la ubicación aproximada de la sesión           |

---

#### TAB:   Tiempo máximo de sesión

| Código | Descripción  | T_max_cargo (minutos) |
|--------|--------------|-----------------|
| 001      | Usuario  | 60 |
...
| Atributo | Naturaleza (tipo de valor) | Formato   | Valores válidos | Unidad | Derivada de | Semántica (descripción) | Ontología (rol en el negocio) |
|------    |----------------------------|-----------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **ID_recupcontra** | INT | 99999999 | NOT NULL | ---- | ---- | Identificador único del proceso de recuperación de contraseña | identifica cada solicitud de recuperación de contraseña |
| **ID_sesion** | INT | 99999999 | NOT NULL | ---- | ---- | Referencia a la sesión activa del usuario durante el proceso de recuperación de contraseña | Vincula la sesión activa del usuario durante la recuperación de contraseña |
| **Estado_Codigo** | CHAR | X (1) | TAB: Estado del codigo generado | ---- | ---- | Estado del código de recuperación indicando su situación actual | Gestiona el ciclo de vida del código de recuperación |
...
| Atributo | Naturaleza (tipo de valor) | Formato   | Valores válidos | Unidad | Derivada de | Semántica (descripción) | Ontología (rol en el negocio) |
|------    |----------------------------|-----------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **ID_autenticacion** | INT | 99999999 | NOT NULL | ---- | ---- | Identificador del mecanismo de autenticación utilizado | Identifica el método específico de autenticación en 2 pasos. |
| **ID_sesion** | INT | 99999999 | NOT NULL | ---- | ---- | Referencia a la sesión activa del usuario durante el proceso de autenticación | Vincula la sesión activa del usuario durante la Autenticacion |
| **Contador_intentos** | INT | X (1) | Minimo  1, máximo 3 | ---- | ---- | Número de intentos realizados por el usuario para ingresar el código de verificación. | Controla la seguridad y detecta intentos fallidos de acceso |
| **Fecha_Hora_Envio** | DATETIME  | AAAA-MM-DD HH:MM  | Válido según el calendario | ---- | ---- | Momento exacto en que se envió el código de verificación al usuario | Registro temporal del envío del código para auditoría y control de seguridad |
| **Estado_Autenticador** | CHAR | X(1) | TAB: Estado del autenticador generado | ---- | ---- | Estado actual del código de verificación enviado al usuario.| Gestiona el ciclo de vida del código y su uso durante la autenticación |
| **Cod_Verificacion** | INT | 9999 | NOT NULL | ---- | ---- | Código único para verificar la identidad del usuario en el inicio de sesión | Clave para validar la identidad en el segundo paso de autenticación. |
...
| Atributo   | Naturaleza (tipo de valor) | Formato        | Valores válidos                      | Unidad | Derivada de | Semántica (descripción)                          | Ontología (rol en el negocio)                       |
|------------|----------------------------|----------------|--------------------------------------|--------|-------------|--------------------------------------------------|----------------------------------------------------|
| **ID_Sesion_sospechosa**| INT | 99999999 | NOT NULL  | ----   | ----        | Identificador único de la sesión sospechosa detectada en el sistema  | Es clave para gestionar sesiones potencialmente inseguras      |
| **ID_autenticacion** | INT | 99999999 | NOT NULL | ---- | ---- | Referencia al proceso de autenticación vinculado a la sesión sospechosa | Conexión con el proceso de autenticación que generó la alerta de sospecha |
...
| **Atributo**      | **Naturaleza (tipo de valor)** | **Formato** | **Valores válidos**        | **Unidad** | **Derivada de** | **Semántica (descripción)**                              | **Ontología (rol en el negocio)**                  |
|-------------------|--------------------------------|-------------|----------------------------|------------|----------------|----------------------------------------------------------|----------------------------------------------------|
| **ID_Administrador**   | INT                            | 99999       |	NOT NULL                  | ----       | ----           | Referencia al administrador que recibirá la notificación    | Identifica a la persona responsable de gestionar la respuesta al evento |
