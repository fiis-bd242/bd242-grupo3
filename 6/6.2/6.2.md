...
| **Horas_uso** | INT | ---- | X > 0 | ---- | ---- | Número de horas de uso acumuladas del equipo | Control de uso |
...
|--------|-------------|
| 1 | Generador |
| 2 | Comprensor de aire |
| 3 | Torre de iluminacion |
| 4 | Sistema de bombeo |
| 5 | Equipos pesados |
...
---
##  Equipos de Soporte X Mantenimiento
| Atributo | Naturaleza (tipo de valor) | Formato   | Valores válidos | Unidad | Derivada de | Semántica (descripción) | Ontología (rol en el negocio) |
|------    |----------------------------|-----------|-----------------|--------|-------------|-------------------------|-------------------------------|
| id_equipo_mant | INT | --- | NO NULO | --- | --- | | | 
| id_equipo_soporte | INT | --- | NO NULO | --- | --- | | |
| id_act_mantto | INT | --- | NO NULO | --- | --- | | |
...
| Atributo   | Naturaleza (tipo de valor) | Formato        | Valores válidos                      | Unidad | Derivada de | Semántica (descripción)                          | Ontología (rol en el negocio)                       |
|------------|----------------------------|----------------|--------------------------------------|--------|-------------|--------------------------------------------------|----------------------------------------------------|
| **RUC**    | CHAR(11)                       | ---    | No nulo                           | ----   | ----        | Identificador de actividades económicas          | Establece relación contractual con la empresa       |
| **Empresa**| VARCHAR(255)                      | ----           | No nulo                              | ----   | ----        | Nombre de la empresa del proveedor               | Establece relación contractual con la empresa       |
| **Nombre**| VARCHAR(255)                   | ----           | No nulo                              | ----   | ----        | Nombre del contacto del proveedor con la organización | Contacto directo con el proveedor cuando sea requerido |
| **Email**  | VARCHAR(255)                     | X*@X*.X        | Dirección correcta según RFC8398     | ----   | ----        | Dirección de correo electrónico del proveedor    | Forma de contacto a través del correo electrónico con el proveedor |
| **Telefono**| CHAR(9)                       | 999999999      | 9 dígitos                            | ----   | ----        | Número de teléfono del proveedor                | Forma de contacto a través del teléfono con el proveedor |
| **Direccion**| VARCHAR(255)                   | ----           | No nulo                              | ----   | ----        | Dirección física de la empresa del proveedor     | Dirección para obtener los equipos y repuestos      |
| **Categoria**| VARCHAR(20)                      | ---              | ---                                 | ----   | ----        | Tipo de insumo que provee                      | Permite identificar el insumo que se provee |
...
| **Fecha_emision_orden**        | DATE                       | AAAA-MM-DD     | válida en calendario         | ----   | ----        | Fecha en la que se emitió la orden de compra         | Fecha de emisión de la orden                                    |
...
| **Id_proveedor**       | INT                        | ---       | No nulo                    | ----   | ----        | Identificador único que identifica al proveedor de la orden de compra   | Identifica al proveedor responsable de la orden de compra   |
| **Id_empleado**       | INT                        | ---       | No nulo                    | ----   | ----        | Identificador único que identifica al responsable de la orden de compra   | Identifica al empleado responsable de la orden de compra   |
...
| Atributo   | Naturaleza (tipo de valor) | Formato        | Valores válidos                      | Unidad | Derivada de | Semántica (descripción)                          | Ontología (rol en el negocio)                       |
|------------|----------------------------|----------------|--------------------------------------|--------|-------------|--------------------------------------------------|----------------------------------------------------|
| **Id_pedido_compra**| INT                      | ---         | No nulo                            | ----   | ----        | Número asociado al registro de un pedido de insumo para determinado mantenimiento               | Permite identificar a un pedido       |
| **Descripcion**    | VARCHAR(255)                     | ---    | no nulo                    | ----   | ----        | Descripcion del pedido de compra | pedido de compra solicitado      |
...
| **Id_estado_pedido**       | INT                        | ---       | TAB: Tipos de estado de un equipo | ----   | ----        | Identifica el estado actual del pedido    | Indica si el estado del pedido |
| **Id_orden_compra**       | INT                        | ---       | nulo                    | ----   | ----        | id del orden de compra asociado al pedido de compra  | Indica el orden de compra del pedido |
...
---
#### TAB: Tipos de urgencia de un pedido
| Código | Descripcion |
|--------|-------------|
| 1 | Baja |
| 2 | Medio |
...
| Atributo   | Naturaleza (tipo de valor) | Formato        | Valores válidos                      | Unidad | Derivada de | Semántica (descripción)                          | Ontología (rol en el negocio)                       |
|------------|----------------------------|----------------|--------------------------------------|--------|-------------|--------------------------------------------------|----------------------------------------------------|
| id_detalle_compra | INT | --- | no nulo | --- | --- | Identificador unico del detalle del pedido | Se utiliza para identificar uno de los items del pedido de compra asignado al detalle |
| cantidad | INT | --- | no nulo | --- | --- | cantidad entera del producto solicitado | cantidad que se solicita adquirir segun el detalle del pedido |
| id_producto | INT | --- | no nulo | --- | --- | identificador del producto | Sirve para identificar el producto que puede ser insumo o equipo de soporte |
| precio_unitario | FLOAT | --- | nulo | --- | --- | precio por unidad del producto | sirve para facturar los pedidos de compra |
| id_tipo_producto | INT | --- | TAB: Tipo de producto | --- | --- | identifica el tipo de producto que se solicita | Sirve para identificar el producto solicitado |
| id_pedido_compra | INT | --- | no nulo | --- | --- | pedido de compra relacionado | sirve para identificar los productos solicitados en el pedido de compra asginado |

---
## TAB: Tipo de producto
| Codigo | Descripcion |
| 1 | Insumo |
| 2 | Equipo de Soporte |
...
| Atributo   | Naturaleza (tipo de valor) | Formato        | Valores válidos                      | Unidad | Derivada de | Semántica (descripción)                          | Ontología (rol en el negocio)                       |
|------------|----------------------------|----------------|--------------------------------------|--------|-------------|--------------------------------------------------|----------------------------------------------------|
| id_historiañ | INT | --- | no nulo | --- | --- | | |
| fecha_cambio | DATE | --- | no nulo | --- | --- | | |
| hora_cambio | TIME | --- | no nulo | --- | --- | | |
| estado_anterior | INT | --- | nulo | --- | --- | | |
| estado_nuevo | INT | --- | no nulo | --- | --- | | |
| id_pedido_compra | INT | --- | no nulo | --- | --- | | |
