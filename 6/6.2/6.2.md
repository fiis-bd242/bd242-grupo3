...
|----------|----------------------------|---------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **Codigo_empleado** | SERIAL | 99999999 | 8 dígitos | ---- | ---- | Identificador unico del empleado | Identificador del empleado en la empresa, clave para todas las operaciones relacionadas con empleados. |
...
| Atributo | Naturaleza (tipo de valor) | Formato   | Valores válidos | Unidad | Derivada de | Semántica (descripción) | Ontología (rol en el negocio) |
|--------- |----------------------------|-----------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **Id_cargo** | SERIAL | 999 | 3 digitos | ---- | ---- | Identidficador unico del cargo del empleado | Permite saber el rol de cada empleado |
...
| Atributo | Naturaleza (tipo de valor) | Formato   | Valores válidos | Unidad | Derivada de | Semántica (descripción) | Ontología (rol en el negocio) |
|------    |----------------------------|-----------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **Cod_almacen** | SERIAL | 9999 | 4 dígitos | ---- | ---- | Identificador unico del almacén | Identifica cada almacén |
...
| Atributo | Naturaleza (tipo de valor) | Formato   | Valores válidos | Unidad | Derivada de | Semántica (descripción) | Ontología (rol en el negocio) |
|--------- |----------------------------|-----------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **Codigo_categoria** | SERIAL | 999 | 3 digitos | ---- | ---- | Identidficador unico de la categoria del almacen | Permite saber la categoria del almacen |
...
| Atributo | Naturaleza (tipo de valor) | Formato   | Valores válidos | Unidad | Derivada de | Semántica (descripción) | Ontología (rol en el negocio) |
|--------- |----------------------------|-----------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **Codigo_estado** | SERIAL | 999 | 3 digitos | ---- | ---- | Identidficador unico del estado del almacen | Permite saber el estado del almacen |
...
| Atributo | Naturaleza (tipo de valor) | Formato   | Valores válidos | Unidad | Derivada de | Semántica (descripción) | Ontología (rol en el negocio) |
|------    |----------------------------|-----------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **Id_equipo_soporte** | SERIAL | 999999 | 6 dígitos | ---- | ---- | Identificador único de cada equipo de soporte | Identificador primario |
...
| **Tipo_equipo_soporte** | INT | 99999 | 5 digitos | ---- | ---- | Tipo de equipo de soporte | Clasificación según función o tipo |
...
---
### Equipo_SoporteXMantenimiento
**Semántica**: Relaciona los equipos de soporte con las actividades de mantenimiento asginadas.

| Atributo | Naturaleza (tipo de valor) | Formato   | Valores válidos | Unidad | Derivada de | Semántica (descripción) | Ontología (rol en el negocio) |
|------    |----------------------------|-----------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **Id_eqsoportexmantto** | SERIAL | 99999999 | 8 dígitos | ---- | ---- | Identificador único de un equipos asignado a un mantenimiento | Identificador primario |
...
| Atributo | Naturaleza (tipo de valor) | Formato   | Valores válidos | Unidad | Derivada de | Semántica (descripción) | Ontología (rol en el negocio) |
|--------- |----------------------------|-----------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **Codigo_disponibilidad** | SERIAL | 999 | 3 digitos | ---- | ---- | Identidficador unico de la disponibilidad del equipo de soporte | Permite saber la disponibilidad del equipo de soporte |
...
| Atributo | Naturaleza (tipo de valor) | Formato   | Valores válidos | Unidad | Derivada de | Semántica (descripción) | Ontología (rol en el negocio) |
|--------- |----------------------------|-----------|-----------------|--------|-------------|-------------------------|-------------------------------|
| **Codigo_estado** | SERIAL | 999 | 3 digitos | ---- | ---- | Identidficador unico del estado del equipo de soporte | Permite saber el estado del equipo de soporte |
