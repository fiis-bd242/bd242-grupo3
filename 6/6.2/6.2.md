...
Semántica: Registro de compra de equipos y repuestos para las actividades de mantenimiento
...
---
## Pedido
Semántica: Todos los pedidos generados que solicitan determinada cantidad de recursos para el mantenimiento de determinada máquinaria
...
---
## Herramienta
Semántica: Todos los recursos disponibles y su cantidad
...
Semántica: Tabla auxiliar para relacion muchos a muchos de recurso,mantenimiento.
...
| Atributo        | Naturaleza (tipo de valor) | Formato     | Valores válidos  | Unidad | Derivada de | Semántica (descripción)                           | Ontología (rol en el negocio)                              |
|-----------------|----------------------------|-------------|------------------|--------|-------------|--------------------------------------------------|------------------------------------------------------------|
| **id_informe_iperc**     | INT                        | 99999999       | 8 dígitos                    | ----   | ----        | Código del informe IPERC                             | Clasifica e identifica el informe de IPERC                        |
