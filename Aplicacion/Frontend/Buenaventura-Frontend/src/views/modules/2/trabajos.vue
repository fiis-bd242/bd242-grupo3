  ...
  methods: {
    async fetchData(page) {
      try {
        ...
        console.log(offset);
        const response = await axios.get(`/api/control/listatrabajos/${offset}`);
    ...
    async searchByMachine() {
      try {
        const response = await axios.get(`/api/planificacion/listaPlanesPorMaquina/${this.searchMachineId}`);
        this.dataList = response.data;
      } catch (error) {
    ...
    async searchByDate() {
      try {
        const response = await axios.get(`/api/planificacion/listaPlanesPorFecha/${this.searchDate}`);
        this.dataList = response.data;
      } catch (error) {
